...
- Server generation cleanup started: added shared project-context loading for Stage 2-6 generation endpoints and shared artifact finalization for Stage 3-6; Stage 2's deterministic outline save/verification remains bespoke for a follow-up pass.
