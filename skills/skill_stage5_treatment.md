...
* **Tic Sunset Execution (ANTI-REPETITION):** A character's physical tic or deflection tactic is a psychological shield. You must not use it mechanically in every sequence. You must actively describe this defense mechanism failing or degrading as the stakes rise, forcing the character to completely abandon it by Act III.
