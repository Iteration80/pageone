...
## Archived 2026-07-03 — pre-refactor entries (March 2026)

*⚠️ These describe the PRE-June-2026 architecture. The brainstorm flag contract (`suggest_plan`/`execute_immediately`), `skills/skill_brainstorm.md`, `postRevisionFollowUp`, and the `/api/brainstorm*` + `/api/style-chat` endpoints described below were all REMOVED in the June 2026 assistant re-architecture. See specs/pageone-refactor-plan-2026-06-11.md and specs/pageone-roadmap-2026-07-03.md.*
